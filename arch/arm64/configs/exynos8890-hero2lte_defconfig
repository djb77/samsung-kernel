...
CONFIG_JOURNAL_DATA_TAG_DEBUG=y
...
# CONFIG_EXYNOS_DECON_8890_DUAL_DISPLAY is not set
# CONFIG_EXYNOS_DECON_DUAL_DSI is not set
...
CONFIG_EXYNOS_SNAPSHOT_SPINLOCK=y
...
CONFIG_EXYNOS_SNAPSHOT_LOGGING_SMC_CALL=y
