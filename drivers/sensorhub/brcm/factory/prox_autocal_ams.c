...
static DEVICE_ATTR(vendor, S_IRUSR | S_IRGRP, proximity_vendor_show, NULL);
static DEVICE_ATTR(name, S_IRUSR | S_IRGRP, proximity_name_show, NULL);
static DEVICE_ATTR(prox_probe, S_IRUSR | S_IRGRP, proximity_probe_show, NULL);
static DEVICE_ATTR(thresh_high, S_IRUSR | S_IRGRP | S_IWUSR | S_IWGRP, proximity_thresh_high_show, proximity_thresh_high_store);
static DEVICE_ATTR(thresh_low, S_IRUSR | S_IRGRP | S_IWUSR | S_IWGRP, proximity_thresh_low_show, proximity_thresh_low_store);
static DEVICE_ATTR(thresh_detect_high, S_IRUSR | S_IRGRP | S_IWUSR | S_IWGRP, proximity_thresh_detect_high_show, proximity_thresh_detect_high_store);
static DEVICE_ATTR(thresh_detect_low, S_IRUSR | S_IRGRP | S_IWUSR | S_IWGRP, proximity_thresh_detect_low_show, proximity_thresh_detect_low_store);
static DEVICE_ATTR(prox_trim, S_IRUSR | S_IRGRP, proximity_default_trim_show, NULL);
static DEVICE_ATTR(raw_data, S_IRUSR | S_IRGRP, proximity_raw_data_show, NULL);
static DEVICE_ATTR(prox_avg, S_IRUSR | S_IRGRP | S_IWUSR | S_IWGRP, proximity_avg_show, proximity_avg_store);

static DEVICE_ATTR(barcode_emul_en, S_IRUSR | S_IRGRP | S_IWUSR | S_IWGRP, barcode_emul_enable_show, barcode_emul_enable_store);

#ifdef CONFIG_SENSORS_SSP_PROX_SETTING
static DEVICE_ATTR(setting, S_IRUSR | S_IRGRP | S_IWUSR | S_IWGRP, proximity_setting_show, proximity_setting_store);
#endif

static DEVICE_ATTR(prox_alert_thresh, S_IRUSR | S_IRGRP, proximity_alert_thresh_show, NULL);
