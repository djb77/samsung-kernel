...
struct init_vclk exynos8895_peric0_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_USI00, USI00_QCH, "GATE_USI00", "UMUX_CLKCMU_PERIC0_USI00", 0, VCLK_GATE | VCLK_QCH_DIS, "fp-spi-pclk"),
#else
...
#ifdef CONFIG_SENSORS_FINGERPRINT
	VCLK(USI00, VCLK_SPL_CLK_PERIC0_USI00_BLK_CMU, "USI00", 0, 0, "fp-spi-sclk"),
#else
