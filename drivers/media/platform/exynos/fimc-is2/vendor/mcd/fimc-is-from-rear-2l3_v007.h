...
#define FROM_HEADER_MODULE_ID_ADDR				0xA8
...
#define FROM_F2_CAL_PAF_ERROR_CHECK_CODE_ADDR		0x5404 /* TEMP */

/* Shading referenced section - REAR2 (TELE) */
#define FROM_REAR2_SHADING_LSC_I0_GAIN_ADDR				0x7006
#define FROM_REAR2_SHADING_LSC_J0_GAIN_ADDR				0x7008
#define FROM_REAR2_SHADING_LSC_A_GAIN_ADDR				0x700A
#define FROM_REAR2_SHADING_LSC_K4_GAIN_ADDR				0x700E
#define FROM_REAR2_SHADING_LSC_SCALE_GAIN_ADDR			0x7012
#define FROM_REAR2_SHADING_LSC_GAIN_START_ADDR			0x7014
#define FROM_REAR2_SHADING_LSC_GAIN_END_ADDR			0x89DB

#define FROM_REAR2_CAL_PAF_ERROR_CHECK_CODE_ADDR		0x8A04 /* TEMP */
/* CRC section */
#define FROM_SHADING_LSC_GAIN_CRC_ADDR				0x29DC
#define FROM_PAF_CRC_ADDR							0x53EC
#define FROM_F2_SHADING_LSC_GAIN_CRC_ADDR			0x43CC
#define FROM_F2_PAF_CRC_ADDR						0x63FC
#define FROM_REAR2_DUAR_CAM_F2_CAL_DATA_CRC_ADDR		0xAAFC
#define FROM_REAR2_SHADING_LSC_GAIN_CRC_ADDR			0x89DC
#define FROM_REAR2_DUAR_CAM_CAL_DATA_CRC_ADDR			0xA2EC

/* AWB referenced section */
#define FROM_REAR_AWB_MASTER_ADDR					0x6430 /* WIDE */
#define FROM_REAR_AWB_MODULE_ADDR					0x6454
#define FROM_REAR_F2_AWB_MASTER_ADDR				0x6470 /* WIDE2 */
#define FROM_REAR_F2_AWB_MODULE_ADDR				0x6494
#define FROM_REAR2_AWB_MASTER_ADDR					0x9A30
#define FROM_REAR2_AWB_MODULE_ADDR					0x9A54

/* Rear2 Cal Dual Calibration Data2 */
#define FROM_REAR2_DUAL_CAL2						0x9B70
#define FROM_REAR2_DUAL_CAL2_SIZE					512

#define FROM_REAR2_DUAL_F2_CAL2					0xA380
#define FROM_REAR2_DUAL_F2_CAL2_SIZE			512

#define FROM_REAR2_DUAL_TILT_X					0x9BCC /* TEMP */
#define FROM_REAR2_DUAL_TILT_Y					0x9BD0
#define FROM_REAR2_DUAL_TILT_Z					0x9BD4
#define FROM_REAR2_DUAL_TILT_SX					0x9C2C
#define FROM_REAR2_DUAL_TILT_SY					0x9C30
#define FROM_REAR2_DUAL_TILT_RANGE				0x9D50
#define FROM_REAR2_DUAL_TILT_MAX_ERR			0x9D54
#define FROM_REAR2_DUAL_TILT_AVG_ERR			0x9D58
#define FROM_REAR2_DUAL_TILT_DLL_VERSION		0x9D4C

/* ISP binary referenced section */
#define FROM_ISP_BINARY_SETFILE_START_ADDR		0xB000
#define FROM_ISP_BINARY_SETFILE_END_ADDR		0x3CDFFF

/* Checksum referenced section */
#define FROM_CHECKSUM_HEADER_ADDR				0xFFC
#define FROM_CHECKSUM_CAL_DATA_ADDR				0x6FFC
#define FROM_CAL_DATA_START_ADDR				0x1000
#define FROM_CAL_DATA_END_ADDR					0x651F

#define FROM_REAR2_CHECKSUM_CAL_DATA_ADDR		0xAFFC
#define FROM_REAR2_CAL_DATA_START_ADDR			0x7000
#define FROM_REAR2_CAL_DATA_END_ADDR			0xAAFF
...
#define FROM_AF_CAL_D10_ADDR				0x6410
#define FROM_AF_CAL_D40_ADDR				0x640C
#define FROM_AF_CAL_D50_ADDR				0x6408
#define FROM_AF_CAL_PAN_ADDR				0x6404
#define FROM_AF_CAL_D80_ADDR				0x6400
#define FROM_AF_CAL_MACRO_ADDR				FROM_AF_CAL_D10_ADDR
#define FROM_AF_CAL_D1_ADDR					FROM_AF_CAL_D40_ADDR

#define FROM_AF2_CAL_D80_ADDR				0x9A00
#define FROM_AF2_CAL_PAN_ADDR				0x9A04 /* 120cm */
#define FROM_AF2_CAL_D50_ADDR				0x9A08
#define FROM_AF2_CAL_D40_ADDR				0x9A0C
#define FROM_AF2_CAL_MACRO_ADDR				0x9A10	/* REAR SECOND SENSOR (TELE) */
#define FROM_AF2_CAL_D1_ADDR				FROM_AF2_CAL_D40_ADDR	/* REAR SECOND SENSOR (TELE) */
...
#define FROM_WRITE_CHECKSUM_SETF_LS			0x9AFFC
#define FROM_WRITE_CHECKSUM_SETF_LL			0x52FFC
