...
#define FROM_F2_PAF_CAL_DATA_START_ADDR			0x5810
...
#define FROM_F2_PAF_OFFSET_MID_ADDR		(FROM_F2_PAF_CAL_DATA_START_ADDR + 0x0730) /* REAR F2 PAF OFFSET MID (30CM, WIDE) */
#define FROM_F2_PAF_OFFSET_MID_SIZE		936
#define FROM_F2_PAF_OFFSET_PAN_ADDR		(FROM_F2_PAF_CAL_DATA_START_ADDR + 0x0CD0) /* REAR F2 PAF OFFSET FAR (1M, WIDE) */
#define FROM_F2_PAF_OFFSET_PAN_SIZE		234
