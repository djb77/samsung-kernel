...
{
	return ((((cis_shared_data *)cis_data)->companion_data.wdr_mode != COMPANION_WDR_OFF && 
		    ((cis_shared_data *)cis_data)->companion_data.wdr_mode != COMPANION_WDR_AUTO_LIKE) ? true : false);
}
