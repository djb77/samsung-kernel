...
#define G2D_DEBUG_MAX_NUM SZ_128
#define G2D_DEBUG_LOG_LENGTH SZ_128
#define G2D_QCH_SIZE (SZ_4 * 21)
...
struct g2d1shot_dev {
	...
	struct {
		...
		char log[G2D_DEBUG_LOG_LENGTH];
	} dbg_logs[G2D_DEBUG_MAX_NUM];
