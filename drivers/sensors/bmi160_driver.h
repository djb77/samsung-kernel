...
#define SENSOR_CHIP_ID_BMI_C3 (0xD2)
...
#define BMI_DELAY_DEFAULT            200000000LL
#define BMI_DELAY_MIN                5000000LL
...
struct bmi_client_data {
	...
	struct device *acc_factory_device;
	struct device *gyro_factory_device;
	struct device *smd_factory_device;
	struct bosch_sensor_data accdata;
	struct bosch_sensor_data caldata;
