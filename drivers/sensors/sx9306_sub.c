...
static void sx9306_sub_initialize_register(struct sx9306_p *data)
{
	...
	for (idx = 0; idx < (sizeof(setup_reg) >> 1); idx++) {
		sx9306_sub_i2c_write(data, setup_reg[idx].reg, setup_reg[idx].val);
...
static void sx9306_sub_read_setupreg(struct device_node *dnode, char *str, u8 *val)
{
	u32 temp_val;
	int ret;
...
static int sx9306_sub_parse_dt(struct sx9306_p *data, struct device *dev)
{
	...
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl0", &setup_reg[SX9306_CTRL0_IDX].val);
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl1", &setup_reg[SX9306_CTRL1_IDX].val);
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl2", &setup_reg[SX9306_CTRL2_IDX].val);
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl3", &setup_reg[SX9306_CTRL3_IDX].val);
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl4", &setup_reg[SX9306_CTRL4_IDX].val);
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl5", &setup_reg[SX9306_CTRL5_IDX].val);
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl6", &setup_reg[SX9306_CTRL6_IDX].val);
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl7", &setup_reg[SX9306_CTRL7_IDX].val);
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl8", &setup_reg[SX9306_CTRL8_IDX].val);
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl9", &setup_reg[SX9306_CTRL9_IDX].val);
	sx9306_sub_read_setupreg(node, "sx9306_sub-i2c,ctrl10", &setup_reg[SX9306_CTRL10_IDX].val);

	ret = of_property_read_u32(node, "sx9306_sub-i2c,normal-thd", &temp_val);
	if (!ret)
			...
			const struct i2c_device_id *id)
{
	...
	/* read chip id */
	ret = sx9306_sub_i2c_write(data, SX9306_SOFTRESET_REG, SX9306_SOFTRESET);
	if (ret < 0) {
