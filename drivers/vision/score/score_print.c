...
static int __score_print_get_front(struct score_print *print)
{
	return readl(print->sfr + PRINT_QUEUE_FRONT_ADDR);
}

static int __score_print_get_rear(struct score_print *print)
{
	return readl(print->sfr + PRINT_QUEUE_REAR_ADDR);
}

static void __score_print_set_front(struct score_print *print, int value)
{
	writel(value, print->sfr + PRINT_QUEUE_FRONT_ADDR);
}

static void __score_print_set_rear(struct score_print *print, int value)
{
	writel(value, print->sfr + PRINT_QUEUE_REAR_ADDR);
}

static void __score_print_set_counter(struct score_print *print, int value)
{
...
void score_print_init(struct score_print *print)
{
	...
	__score_print_set_counter(print, 0);
}
