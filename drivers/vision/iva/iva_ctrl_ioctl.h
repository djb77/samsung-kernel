...
/* TO DO : seperate files for each functionality*/
...
#define IVA_IPC_QUEUE_SEND_CMD		_IOW(IVA_CTRL_MAGIC, 4, struct ipc_cmd_param)
#define IVA_IPC_QUEUE_RECEIVE_RSP	_IOR(IVA_CTRL_MAGIC, 5, struct ipc_res_param)

#define IVA_MBOX_SEND_MSG		_IOW(IVA_CTRL_MAGIC, 6, uint32_t)
