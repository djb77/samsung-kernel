/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3hf3/s6e3hf3_dimming.h
 *
...
#ifndef __S6E3HF3_DIMMING_H__
#define __S6E3HF3_DIMMING_H__
#include <linux/types.h>
#include <linux/kernel.h>
#include "../dimming.h"

#define S6E3HF3_NR_TP (10)

#define S6E3HF3_NR_LUMINANCE (74)
#define S6E3HF3_TARGET_LUMINANCE (420)

#define S6E3HF3_NR_HBM_LUMINANCE (8)
#define S6E3HF3_TARGET_HBM_LUMINANCE (600)

#define S6E3HF3_HMD_NR_LUMINANCE (37)
#define S6E3HF3_HMD_TARGET_LUMINANCE (420)

#ifdef CONFIG_LCD_EXTEND_HBM
#define S6E3HF3_NR_EXTEND_HBM_LUMINANCE	(1)
#define S6E3HF3_TARGET_EXTEND_HBM_LUMINANCE	(720)
#define S6E3HF3_TOTAL_NR_LUMINANCE (S6E3HF3_NR_LUMINANCE + S6E3HF3_NR_HBM_LUMINANCE + S6E3HF3_NR_EXTEND_HBM_LUMINANCE)
#define S6E3HF3_HMD_TOTAL_NR_LUMINANCE (S6E3HF3_HMD_NR_LUMINANCE)
#else
#define S6E3HF3_TOTAL_NR_LUMINANCE (S6E3HF3_NR_LUMINANCE + S6E3HF3_NR_HBM_LUMINANCE)
#define S6E3HF3_HMD_TOTAL_NR_LUMINANCE (S6E3HF3_HMD_NR_LUMINANCE)
#endif

#define S6E3HF3_TOTAL_PAC_STEPS		(PANEL_BACKLIGHT_PAC_STEPS + S6E3HF3_NR_HBM_LUMINANCE + S6E3HF3_NR_EXTEND_HBM_LUMINANCE)

static struct tp s6e3hf3_tp[S6E3HF3_NR_TP] = {
