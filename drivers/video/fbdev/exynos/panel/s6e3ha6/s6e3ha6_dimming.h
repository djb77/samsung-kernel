...
#define S6E3HA6_NR_HBM_LUMINANCE (8)
#define S6E3HA6_TARGET_HBM_LUMINANCE (600)

#define S6E3HA6_STAR_NR_HBM_LUMINANCE (12)
#define S6E3HA6_STAR_TARGET_HBM_LUMINANCE (700)
...
#define S6E3HA6_STAR_TOTAL_NR_LUMINANCE (S6E3HA6_NR_LUMINANCE + S6E3HA6_STAR_NR_HBM_LUMINANCE + S6E3HA6_NR_EXTEND_HBM_LUMINANCE)
...
#define S6E3HA6_STAR_TOTAL_NR_LUMINANCE (S6E3HA6_NR_LUMINANCE + S6E3HA6_STAR_NR_HBM_LUMINANCE)
#define S6E3HA6_HMD_TOTAL_NR_LUMINANCE (S6E3HA6_HMD_NR_LUMINANCE)
#endif

#define S6E3HA6_TOTAL_PAC_STEPS		(PANEL_BACKLIGHT_PAC_STEPS + S6E3HA6_NR_HBM_LUMINANCE + S6E3HA6_NR_EXTEND_HBM_LUMINANCE)
#define S6E3HA6_STAR_TOTAL_PAC_STEPS		(PANEL_BACKLIGHT_PAC_STEPS + S6E3HA6_STAR_NR_HBM_LUMINANCE + S6E3HA6_NR_EXTEND_HBM_LUMINANCE)
