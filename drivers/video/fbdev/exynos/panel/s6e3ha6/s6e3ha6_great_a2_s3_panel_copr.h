...
static DEFINE_PKTUI(great_a2_s3_copr, &great_a2_s3_copr_maptbl[COPR_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(great_a2_s3_copr, DSI_PKT_TYPE_WR, GREAT_A2_S3_COPR, 0);
