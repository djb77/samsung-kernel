...
static DEFINE_PKTUI(dream_a3_da_copr, &dream_a3_da_copr_maptbl[COPR_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(dream_a3_da_copr, DSI_PKT_TYPE_WR, DREAM_A3_DA_COPR, 0);
