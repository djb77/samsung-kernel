...
static DEFINE_PKTUI(dream2_a3_sa_copr, &dream2_a3_sa_copr_maptbl[COPR_MAPTBL], 1);
static DEFINE_VARIABLE_PACKET(dream2_a3_sa_copr, DSI_PKT_TYPE_WR, DREAM2_A3_SA_COPR, 0);
