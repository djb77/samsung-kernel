 ...
 * <example>
 * XXX 1st param => S6E3HF4_XXX_OFS (0)
 * XXX 2nd param => S6E3HF4_XXX_OFS (1)
 * XXX 36th param => S6E3HF4_XXX_OFS (35)
 */

#define AID_INTERPOLATION
#define GAMMA_CMD_CNT 36

#define S6E3HF4_ADDR_OFS	(0)
#define S6E3HF4_ADDR_LEN	(1)
#define S6E3HF4_DATA_OFS	(S6E3HF4_ADDR_OFS + S6E3HF4_ADDR_LEN)

#ifdef CONFIG_LCD_EXTEND_HBM
#define S6E3HF4_MAX_BRIGHTNESS (EXTEND_HBM_MAX_BRIGHTNESS)
#else
...
#define S6E3HF4_DATE_LEN			(PANEL_DATE_LEN)

#define S6E3HF4_COORDINATE_REG		0xA1
#define S6E3HF4_COORDINATE_OFS		0
#define S6E3HF4_COORDINATE_LEN		(PANEL_COORD_LEN)
...
#define S6E3HF4_HBM_GAMMA_LEN		(S6E3HF4_HBM_GAMMA_0_LEN + S6E3HF4_HBM_GAMMA_1_LEN)

#define S6E3HF4_ID_REG				0x04
#define S6E3HF4_ID_OFS				0
#define S6E3HF4_ID_LEN				(PANEL_ID_LEN)

#define S6E3HF4_CODE_REG			0xD6
#define S6E3HF4_CODE_OFS			1
#define S6E3HF4_CODE_LEN			(PANEL_CODE_LEN)
...
#define S6E3HF4_OCTA_ID_LEN			(PANEL_OCTA_ID_LEN)
#endif

#define S6E3HF4_CHIP_ID_REG			0xD6
#define S6E3HF4_CHIP_ID_OFS			0
#define S6E3HF4_CHIP_ID_LEN			5

/* for panel dump */
#define S6E3HF4_RDDPM_REG			0x0A
#define S6E3HF4_RDDPM_OFS			0
#define S6E3HF4_RDDPM_LEN			3

#define S6E3HF4_RDDSM_REG			0x0E
#define S6E3HF4_RDDSM_OFS			0
#define S6E3HF4_RDDSM_LEN			3

#define S6E3HF4_ERR_REG				0xEA
#define S6E3HF4_ERR_OFS				0
#define S6E3HF4_ERR_LEN				5

#define S6E3HF4_ERR_FG_REG			0xEE
#define S6E3HF4_ERR_FG_OFS			0
#define S6E3HF4_ERR_FG_LEN			1

#define S6E3HF4_DSI_ERR_REG			0x05
#define S6E3HF4_DSI_ERR_OFS			0
#define S6E3HF4_DSI_ERR_LEN			1

#define S6E3HF4_SELF_DIAG_REG			0x0F
#define S6E3HF4_SELF_DIAG_OFS			0
#define S6E3HF4_SELF_DIAG_LEN			1
...
#define S6E3HF4_SCR_CR_OFS	(31)
#define S6E3HF4_SCR_WR_OFS	(49)
#define S6E3HF4_SCR_WG_OFS	(51)
...
static u8 S6E3HF4_ID[S6E3HF4_ID_LEN];
static u8 S6E3HF4_COORDINATE[S6E3HF4_COORDINATE_LEN];
static u8 S6E3HF4_CODE[S6E3HF4_CODE_LEN];
static u8 S6E3HF4_ELVSS[S6E3HF4_ELVSS_LEN];
static u8 S6E3HF4_ELVSS_TEMP[S6E3HF4_ELVSS_TEMP_LEN];
static u8 S6E3HF4_MTP[S6E3HF4_MTP_LEN];
static u8 S6E3HF4_DATE[S6E3HF4_DATE_LEN];
static u8 S6E3HF4_HBM_GAMMA[S6E3HF4_HBM_GAMMA_LEN];
#ifdef CONFIG_SEC_FACTORY
static u8 S6E3HF4_OCTA_ID[S6E3HF4_OCTA_ID_LEN];
#endif

static u8 S6E3HF4_CHIP_ID[S6E3HF4_CHIP_ID_LEN];
static u8 S6E3HF4_RDDPM[S6E3HF4_RDDPM_LEN];
static u8 S6E3HF4_RDDSM[S6E3HF4_RDDSM_LEN];
static u8 S6E3HF4_ERR[S6E3HF4_ERR_LEN];
static u8 S6E3HF4_ERR_FG[S6E3HF4_ERR_FG_LEN];
static u8 S6E3HF4_DSI_ERR[S6E3HF4_DSI_ERR_LEN];
static u8 S6E3HF4_SELF_DIAG[S6E3HF4_SELF_DIAG_LEN];

static struct rdinfo s6e3hf4_rditbl[] = {
	[READ_ID] = RDINFO_INIT(id, DSI_PKT_TYPE_RD, S6E3HF4_ID_REG, S6E3HF4_ID_OFS, S6E3HF4_ID_LEN),
	[READ_COORDINATE] = RDINFO_INIT(coordinate, DSI_PKT_TYPE_RD, S6E3HF4_COORDINATE_REG, S6E3HF4_COORDINATE_OFS, S6E3HF4_COORDINATE_LEN),
	[READ_CODE] = RDINFO_INIT(code, DSI_PKT_TYPE_RD, S6E3HF4_CODE_REG, S6E3HF4_CODE_OFS, S6E3HF4_CODE_LEN),
	[READ_ELVSS] = RDINFO_INIT(elvss, DSI_PKT_TYPE_RD, S6E3HF4_ELVSS_REG, S6E3HF4_ELVSS_OFS, S6E3HF4_ELVSS_LEN),
	[READ_ELVSS_TEMP] = RDINFO_INIT(elvss_temp, DSI_PKT_TYPE_RD, S6E3HF4_ELVSS_TEMP_REG, S6E3HF4_ELVSS_TEMP_OFS, S6E3HF4_ELVSS_TEMP_LEN),
	[READ_MTP] = RDINFO_INIT(mtp, DSI_PKT_TYPE_RD, S6E3HF4_MTP_REG, S6E3HF4_MTP_OFS, S6E3HF4_MTP_LEN),
	[READ_DATE] = RDINFO_INIT(date, DSI_PKT_TYPE_RD, S6E3HF4_DATE_REG, S6E3HF4_DATE_OFS, S6E3HF4_DATE_LEN),
	[READ_HBM_GAMMA_0] = RDINFO_INIT(hbm_gamma_0, DSI_PKT_TYPE_RD, S6E3HF4_HBM_GAMMA_0_REG, S6E3HF4_HBM_GAMMA_0_OFS, S6E3HF4_HBM_GAMMA_0_LEN),
	[READ_HBM_GAMMA_1] = RDINFO_INIT(hbm_gamma_1, DSI_PKT_TYPE_RD, S6E3HF4_HBM_GAMMA_1_REG, S6E3HF4_HBM_GAMMA_1_OFS, S6E3HF4_HBM_GAMMA_1_LEN),
#ifdef CONFIG_SEC_FACTORY
	[READ_OCTA_ID] = RDINFO_INIT(octa_id, DSI_PKT_TYPE_RD, S6E3HF4_OCTA_ID_REG, S6E3HF4_OCTA_ID_OFS, S6E3HF4_OCTA_ID_LEN),
#endif
	[READ_CHIP_ID] = RDINFO_INIT(chip_id, DSI_PKT_TYPE_RD, S6E3HF4_CHIP_ID_REG, S6E3HF4_CHIP_ID_OFS, S6E3HF4_CHIP_ID_LEN),
	[READ_RDDPM] = RDINFO_INIT(rddpm, DSI_PKT_TYPE_RD, S6E3HF4_RDDPM_REG, S6E3HF4_RDDPM_OFS, S6E3HF4_RDDPM_LEN),
	[READ_RDDSM] = RDINFO_INIT(rddsm, DSI_PKT_TYPE_RD, S6E3HF4_RDDSM_REG, S6E3HF4_RDDSM_OFS, S6E3HF4_RDDSM_LEN),
	[READ_ERR] = RDINFO_INIT(err, DSI_PKT_TYPE_RD, S6E3HF4_ERR_REG, S6E3HF4_ERR_OFS, S6E3HF4_ERR_LEN),
	[READ_ERR_FG] = RDINFO_INIT(err_fg, DSI_PKT_TYPE_RD, S6E3HF4_ERR_FG_REG, S6E3HF4_ERR_FG_OFS, S6E3HF4_ERR_FG_LEN),
	[READ_DSI_ERR] = RDINFO_INIT(dsi_err, DSI_PKT_TYPE_RD, S6E3HF4_DSI_ERR_REG, S6E3HF4_DSI_ERR_OFS, S6E3HF4_DSI_ERR_LEN),
	[READ_SELF_DIAG] = RDINFO_INIT(self_diag, DSI_PKT_TYPE_RD, S6E3HF4_SELF_DIAG_REG, S6E3HF4_SELF_DIAG_OFS, S6E3HF4_SELF_DIAG_LEN),
};
...
#endif
static DEFINE_RESUI(chip_id, &s6e3hf4_rditbl[READ_CHIP_ID], 0);
static DEFINE_RESUI(rddpm, &s6e3hf4_rditbl[READ_RDDPM], 0);
static DEFINE_RESUI(rddsm, &s6e3hf4_rditbl[READ_RDDSM], 0);
static DEFINE_RESUI(err, &s6e3hf4_rditbl[READ_ERR], 0);
static DEFINE_RESUI(err_fg, &s6e3hf4_rditbl[READ_ERR_FG], 0);
static DEFINE_RESUI(dsi_err, &s6e3hf4_rditbl[READ_DSI_ERR], 0);
static DEFINE_RESUI(self_diag, &s6e3hf4_rditbl[READ_SELF_DIAG], 0);

static struct resinfo s6e3hf4_restbl[] = {
	[RES_ID] = RESINFO_INIT(id, S6E3HF4_ID, RESUI(id)),
	[RES_COORDINATE] = RESINFO_INIT(coordinate, S6E3HF4_COORDINATE, RESUI(coordinate)),
	[RES_CODE] = RESINFO_INIT(code, S6E3HF4_CODE, RESUI(code)),
	[RES_ELVSS] = RESINFO_INIT(elvss, S6E3HF4_ELVSS, RESUI(elvss)),
	[RES_ELVSS_TEMP] = RESINFO_INIT(elvss_temp, S6E3HF4_ELVSS_TEMP, RESUI(elvss_temp)),
	[RES_MTP] = RESINFO_INIT(mtp, S6E3HF4_MTP, RESUI(mtp)),
	[RES_DATE] = RESINFO_INIT(date, S6E3HF4_DATE, RESUI(date)),
	[RES_HBM_GAMMA] = RESINFO_INIT(hbm_gamma, S6E3HF4_HBM_GAMMA, RESUI(hbm_gamma)),
#ifdef CONFIG_SEC_FACTORY
	[RES_OCTA_ID] = RESINFO_INIT(octa_id, S6E3HF4_OCTA_ID, RESUI(octa_id)),
#endif
	[RES_CHIP_ID] = RESINFO_INIT(chip_id, S6E3HF4_CHIP_ID, RESUI(chip_id)),
	[RES_RDDPM] = RESINFO_INIT(rddpm, S6E3HF4_RDDPM, RESUI(rddpm)),
	[RES_RDDSM] = RESINFO_INIT(rddsm, S6E3HF4_RDDSM, RESUI(rddsm)),
	[RES_ERR] = RESINFO_INIT(err, S6E3HF4_ERR, RESUI(err)),
	[RES_ERR_FG] = RESINFO_INIT(err_fg, S6E3HF4_ERR_FG, RESUI(err_fg)),
	[RES_DSI_ERR] = RESINFO_INIT(dsi_err, S6E3HF4_DSI_ERR, RESUI(dsi_err)),
	[RES_SELF_DIAG] = RESINFO_INIT(self_diag, S6E3HF4_SELF_DIAG, RESUI(self_diag)),
};
