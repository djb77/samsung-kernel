...
#define S6E3HF3_MAX_BRIGHTNESS (EXTEND_HBM_MAX_BRIGHTNESS)
#else
#define S6E3HF3_MAX_BRIGHTNESS (HBM_MAX_BRIGHTNESS)
#endif
...
static struct dumpinfo s6e3hf3_dmptbl[] = {
	[DUMP_RDDPM] = DUMPINFO_INIT(rddpm, &s6e3hf3_restbl[RES_RDDPM], show_rddpm),
	[DUMP_RDDSM] = DUMPINFO_INIT(rddsm, &s6e3hf3_restbl[RES_RDDSM], show_rddsm),
	[DUMP_ERR] = DUMPINFO_INIT(err, &s6e3hf3_restbl[RES_ERR], show_err),
	[DUMP_ERR_FG] = DUMPINFO_INIT(err_fg, &s6e3hf3_restbl[RES_ERR_FG], show_err_fg),
	[DUMP_DSI_ERR] = DUMPINFO_INIT(dsi_err, &s6e3hf3_restbl[RES_DSI_ERR], show_dsi_err),
	[DUMP_SELF_DIAG] = DUMPINFO_INIT(self_diag, &s6e3hf3_restbl[RES_SELF_DIAG], show_self_diag),
};
