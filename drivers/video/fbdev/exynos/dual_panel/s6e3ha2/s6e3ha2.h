...
#define NR_S6E3HA2_MDNIE_REG	(3)

#define S6E3HA2_MDNIE_0_REG		(0xDF)
#define S6E3HA2_MDNIE_0_OFS		(0)
#define S6E3HA2_MDNIE_0_LEN		(71)

#define S6E3HA2_MDNIE_1_REG		(0xDE)
#define S6E3HA2_MDNIE_1_OFS		(S6E3HA2_MDNIE_0_OFS + S6E3HA2_MDNIE_0_LEN)
#define S6E3HA2_MDNIE_1_LEN		(208)

#define S6E3HA2_MDNIE_2_REG		(0xDD)
#define S6E3HA2_MDNIE_2_OFS		(S6E3HA2_MDNIE_1_OFS + S6E3HA2_MDNIE_1_LEN)
#define S6E3HA2_MDNIE_2_LEN		(18)
#define S6E3HA2_MDNIE_LEN		(S6E3HA2_MDNIE_0_LEN + S6E3HA2_MDNIE_1_LEN + S6E3HA2_MDNIE_2_LEN)

#define S6E3HA2_SCR_CR_OFS	(31)
#define S6E3HA2_SCR_WR_OFS	(49)
#define S6E3HA2_SCR_WG_OFS	(51)
#define S6E3HA2_SCR_WB_OFS	(53)
