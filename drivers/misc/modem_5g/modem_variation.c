...
#ifndef CONFIG_UMTS_MODEM_SS5G
DECLARE_MODEM_INIT_DUMMY(ss5g)
#endif
...
#ifndef CONFIG_LINK_DEVICE_PCI
DECLARE_LINK_INIT_DUMMY(pci)
#endif
...
static link_init_call link_init_func[LINKDEV_MAX] = {
	...
	[LINKDEV_PCI] = LINK_INIT_CALL(pci),
};
