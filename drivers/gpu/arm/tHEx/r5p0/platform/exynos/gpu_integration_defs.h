...
#define CACHE_CLEAN_WQ_PARAM		(WQ_UNBOUND | __WQ_ORDERED)
#define RESET_WQ_PARAM				(WQ_UNBOUND | __WQ_ORDERED)
#define PM_POWEROFF_WQ_PARAM		(__WQ_ORDERED)
#define JOB_DONE_WQ_PARAM			(__WQ_ORDERED)
#define JOB_FAULT_RESUME_WQ_PARAM	(WQ_UNBOUND | __WQ_ORDERED)
#define AS_PF_WQ_PARAM				(WQ_UNBOUND | __WQ_ORDERED)
#define AS_POKE_WQ_PARAM			(WQ_UNBOUND | __WQ_ORDERED)
#define DMA_FENCE_WQ_PARAM			(__WQ_ORDERED)
#define KBASE_EVENT_WQ_PARAM		(WQ_UNBOUND | __WQ_ORDERED)
