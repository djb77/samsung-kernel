...
void __kbase_tlstream_tl_attrib_atom_jit_alloc_count(void *atom, u32 count);
...
/**
 * KBASE_TLSTREAM_TL_EVENT_ATOM_SOFTSTOP_ISSUES
 * @atom:       atom identifier
 */
...
/**
 * KBASE_TLSTREAM_TL_ATTRIB_ATOM_JIT_ALLOC_COUNT
 * @atom:       atom identifier
 * @count:      JIT allocation count
 *
 * This tracepoint shows how many JIT allocs are allocated at the time
 * this atom is processed. Intended to be used with JIT allocation atoms.
 */
#define KBASE_TLSTREAM_TL_ATTRIB_ATOM_JIT_ALLOC_COUNT(atom, count) \
	__TRACE_IF_ENABLED(tl_attrib_atom_jit_alloc_count, atom, count)
