...
enum tl_msg_id_obj {
	...
	KBASE_TL_ATTRIB_ATOM_JIT_ALLOC_COUNT,
...
static const struct tp_desc tp_desc_obj[] = {
	...
	{
		KBASE_TL_ATTRIB_ATOM_JIT_ALLOC_COUNT,
		__stringify(KBASE_TL_ATTRIB_ATOM_JIT_ALLOC_COUNT),
		"jit alloc count",
		"@pI",
		"atom,count"
	},
...
{
	const u32     msg_id = KBASE_TL_ATTRIB_ATOM_JIT_ALLOC_COUNT;
	const size_t  msg_size =
		sizeof(msg_id) + sizeof(u64) + sizeof(atom) + sizeof(count);
	unsigned long flags;
	char          *buffer;
	size_t        pos = 0;
