...
enum {
    ...
    SM5708_CHARGER_OP_MODE_WPC_OTG_CHG_OFF     = 0x2,
    SM5708_CHARGER_OP_MODE_WPC_OTG_CHG_ON      = 0x3,
    SM5708_CHARGER_OP_MODE_CHG_OFF             = 0x4,
    SM5708_CHARGER_OP_MODE_CHG_ON              = 0x5,
    SM5708_CHARGER_OP_MODE_FLASH_BOOST         = 0x6,
    SM5708_CHARGER_OP_MODE_USB_OTG             = 0x7,
};

enum SM5708_CHARGER_OP_EVENT_TYPE {
    SM5708_CHARGER_OP_EVENT_VBUS                = 0x5,
    SM5708_CHARGER_OP_EVENT_WPC                 = 0x4,
...
#define make_OP_STATUS(vbus,wpc,flash,torch,otg,pwr_shar)   (((vbus & 0x1) << SM5708_CHARGER_OP_EVENT_VBUS)         | \
                                                             ((wpc & 0x1) << SM5708_CHARGER_OP_EVENT_WPC)           | \
